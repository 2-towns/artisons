...
func adminRouter() http.Handler {
	...
	r.Get("/tags.html", admin.Tags)
	r.Get("/tags/add.html", admin.AddTagForm)
	r.Get("/tags/{id}/edit.html", admin.EditTagForm)
	...
	r.Post("/tags/add.html", admin.AddTag)
	r.Post("/tags/{id}/edit.html", admin.EditTag)
	r.Post("/tags/{id}/delete.html", admin.DeleteTag)
