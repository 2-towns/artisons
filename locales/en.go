...
func LoadEn() {
	...
	message.SetString(language.English, "Separate your tags by a ';'.", "Separate your tags by a ';'.")
	message.SetString(language.English, "You can separate the words inside a tag by using a uppercase letter.", "You can separate the words inside a tag by using a uppercase letter.")
