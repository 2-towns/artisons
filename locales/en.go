...
func LoadEn() {
	...
	message.SetString(language.English, "Advanced search", "Advanced search")
	message.SetString(language.English, "Enable the advanced search allowing the user to select multiple criteria.", "Enable the advanced search allowing the user to select multiple criteria.")
	...
	message.SetString(language.English, "Last quantity", "Last quantity")
	message.SetString(language.English, "You can display an alert when a stock of your products gets low.", "You can display an alert when a stock of your products gets low.")
